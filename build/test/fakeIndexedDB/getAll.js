...
describe("getAll", function () {
    ...
    it("should work with query parameter", function (done) {
        var request = db.transaction("store").objectStore("store").getAll(FDBKeyRange_1.default.bound(2, 5));
        request.onsuccess = function (e) {
    ...
    it("should work with query and count parameters", function (done) {
        var request = db.transaction("store").objectStore("store").getAll(FDBKeyRange_1.default.lowerBound(6), 3);
        request.onsuccess = function (e) {
            assert.equal(e.target.result.length, 3);
...
describe("getAllKeys", function () {
    ...
    it("should work with query parameter", function (done) {
        var request = db.transaction("store").objectStore("store").getAllKeys(FDBKeyRange_1.default.bound(2, 5));
        request.onsuccess = function (e) {
            assert.equal(e.target.result.length, 4);
    ...
    it("should work with query and count parameters", function (done) {
        var request = db.transaction("store").objectStore("store").getAllKeys(FDBKeyRange_1.default.lowerBound(6), 3);
        request.onsuccess = function (e) {
            assert.equal(e.target.result.length, 3);
